...
public class View extends JFrame{
	...
	private JLabel Opponent1CardsinPlayL;
	private JList Opp1CardsinPlayList, HumanCardsInHandList;;
		...
		PlayerGrid.setSize(WIDTH, HEIGHT-150);
			...
			//Opponent1
				...
				Opponent1Grid.setLayout(new FlowLayout());
					...
					Opponent1CardsinPlayL = new JLabel("Cards in Play", SwingConstants.LEFT);
					String[] CardNames = {"Card 1, Card 2, Card 3"};	
					Opp1CardsinPlayList = new JList(CardNames);
					Opp1CardsinPlayList.setBorder(BorderFactory.createLineBorder(Color.black));
					Opp1CardsinPlayList.setSize(100, 100);
				...
				//Human
				Container HumanGrid = new JPanel();
					HumanNameL = new JLabel("Human", SwingConstants.LEFT);
					String[] HumanCardNames = {"Card 1, Card 2, Card 3"};	
					HumanCardsInHandList = new JList(HumanCardNames);
				
						
				PlayerGrid.add(Opponent1Grid);
				//Opponent1Grid.add(Opponent1NameL);
				//Opponent1Grid.add(Opponent1CardsinPlayL);
				Opponent1Grid.add(Opp1CardsinPlayList);
				
				PlayerGrid.add(Opponent2NameL);
				PlayerGrid.add(Opponent3NameL);
				
				PlayerGrid.add(HumanGrid);
				HumanGrid.add(HumanNameL);
				HumanGrid.add(HumanCardsInHandList);
